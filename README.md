...
This project focuses on tackling the challenge of out-of-distribution detection in video actions. By utilizing the widely-used UCF101 dataset, we have implemented a robust framework using the I3d architecture to extract rich features from videos. These features are then leveraged to classify and identify unseen actions accurately.

You can find a demo showcasing our methodology on YouTube at the following link:
https://www.youtube.com/watch?v=047P57EPYnw

The primary goal of our project was to develop a state-of-the-art OOD detection system for video actions. We have implemented our solution using the following key components and tools:
...
2. **Download the project from this link:** : https://drive.google.com/drive/folders/1IE-6zY_gp9mYJODZbZmvVGg0XrU5YbGE
