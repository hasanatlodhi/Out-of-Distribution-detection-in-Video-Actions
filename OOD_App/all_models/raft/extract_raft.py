...
import omegaconf
from ...all_models._base.base_flow_extractor import BaseOpticalFlowExtractor
import os
# defined as a constant here, because i3d imports it
DATASET_to_RAFT_CKPT_PATHS = {
    'sintel': f'{os.getcwd()}/OOD_App/all_models/raft/checkpoints/raft-sintel.pth',
    'kitti': f'{os.getcwd()}/OOD_App/all_models/raft/checkpoints/raft-kitti.pth',
}
